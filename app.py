...
with tab1:
    ...
    # CASH (basado en checkout HOY por rango)
    ...
    # --- 🚗 Estacionamientos activos HOY (incluye check-ins anteriores)
    ...
    # 🧑‍🏫 Conserje (Estacionamiento usa activos del día)
